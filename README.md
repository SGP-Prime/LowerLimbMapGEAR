...
Interactive map of the **lumbosacral plexus** and the ultrasound-guided lower-limb nerve blocks — Session 2 of the GEAR (Grupo de Ecografia e Anestesia Regional) resident lessons.

Companion to Lesson 1 ([UpperLimbMapGEAR](https://github.com/SGP-Prime/UpperLimbMapGEAR)).
...
Sciatic family: subgluteal, anterior, popliteal, iPACK.
Terminal / knee: saphenous, genicular nerve block, ankle block.

---
GEAR · Grupo de Ecografia e Anestesia Regional
